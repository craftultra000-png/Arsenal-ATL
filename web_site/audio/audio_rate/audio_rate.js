...
// ── 7. التصدير — Tone.Offline على main thread ───────────────────
// OfflineAudioContext غير مدعوم داخل Web Workers على موبايل،
// لذا نعتمد Tone.Offline مباشرة وهو الحل الأصيل للمنصة.
function renderViaWorker(format) {
    workerProgressSection.style.display = 'block';
    workerProgressLabel.innerText = 'جاري تصيير الصوت...';
    workerProgressPct.innerText   = '';
    workerProgressFill.style.width = '0%';

    return renderAudioOfflineFallback().then((result) => {
